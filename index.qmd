---
title: MCP 101
subtitle: Composable Agents with Model Context Protocol
...
- **200+ existing servers**: Ready to use
...
1. **Try the demo** in this repo
2. **Pick a daily tool** to wrap
...
- **FastMCP**: High-level Python development
